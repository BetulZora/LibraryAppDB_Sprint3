...
public class US05_RSS_StepDefs {

    @Given("Establish the database connection RSS")
    public void establish_the_database_connection_rss() {
        //next step
    }
    ...
    @Then("verify {string} is the most popular book genre. RSS")
    public void verify_is_the_most_popular_book_genre_rss(String expectedCategory) {
        System.out.println("mostPopularBookCategory = " + mostPopularBookCategory);
